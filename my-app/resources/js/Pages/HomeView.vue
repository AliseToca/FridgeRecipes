...
export default {
  ...
  data() {
    return {
      searchQuery: '',
      recipes: [
        { id: 1, name: 'Healthy Rich Salad', img: '/images/recipe/salad.jpg', minutes: 12, rating: 3, ingredients: 6 },
        { id: 2, name: 'Butter chicken', img: '/images/recipe/butter-chicken-test.jpg', minutes: 15, rating: 4, ingredients: 4 },
        { id: 3, name: 'Eggs and bacon', img: '/images/recipe/bacon-and-eggs.jpg', minutes: 10, rating: 2, ingredients: 8 },
        { id: 4, name: 'Kikas special', img: '/images/recipe/kika-special.jpg', minutes: 60, rating: 6, ingredients: 9 },
